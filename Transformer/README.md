...
## Example Output
Input: The original question or prompt provided to the model.
Predicted: The response generated by the model based on the input.
Actual: The correct or expected response for the given input.
